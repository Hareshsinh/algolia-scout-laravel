...
<body>
<div class="container">
    <h1>Search with Laravel Scout and Vue.js!</h1>
    ...
    <div id="products" class="row list-group">
        <div class="item col-xs-4 col-lg-4" v-for="product in products">
            <div class="thumbnail">
                ...
                <div class="caption">
                    <h4 class="group inner list-group-item-heading">Name : @{{ product.name }}</h4>
                    <h4 class="group inner list-group-item-heading">Company Name :  @{{ product.company }}</h4>
                    <div class="row">
                        <div class="col-xs-12 col-md-6">
                            <p class="lead">email : @{{ product.email }}</p>
                        </div>
{{--                        <div class="col-xs-12 col-md-6">--}}
